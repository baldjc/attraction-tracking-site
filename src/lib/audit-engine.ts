...
- **No Unsourced Factual Claims (specifics must trace to data or a Knowledge Base profile):** Grounding applies to specific factual claims, not just market numbers. **FAIL** and quote the line if the script asserts a specific, verifiable claim about the area that cannot trace to the member's data or Knowledge Base neighbourhood profile — e.g. an invented demographic figure ("median household income of $95,000," "median age of 34"), a population count, a dated event ("the new school that opened in 2019," "built in the 1980s"), or a named-institution attribute presented as fact. General, experience-based statements are fine ("a family-friendly area," "after years working this market"); invented specifics are not. Quote the claim and recommend either grounding it in a real source or generalising it.
