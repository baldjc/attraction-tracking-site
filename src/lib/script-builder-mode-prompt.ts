...
- Every quantitative market claim in the body MUST appear here — EVERY number family, not just months of inventory and price. That means failure rates (e.g. "181%", "72%"), sale-to-list ratios, days on market, price per square foot, absorption — all of them. A number you cannot map to a provided fact id must NOT appear in the script at all — remove it. (The server-side \`unlisted_market_stat\` validator rejects any real number spoken in the body but missing from this footnote.)
