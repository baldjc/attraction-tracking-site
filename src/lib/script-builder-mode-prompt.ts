...
- **Sub-floor cuts are TEXTURE, never a headline.** A computed group below the headline sold floor arrives carrying a viewer caveat. Use it only as supporting colour inside the body — NEVER as the title payoff, the hook stat, or a standalone headline claim. A zero-sale group carries no numbers at all; do not manufacture one for it.
