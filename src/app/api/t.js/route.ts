...
// Client-side guard: window._atbvFired prevents multiple fires on the same page load.
// Server-side guard: if we already recorded a click for this refCode+IP within 30s,
// return the existing session_id instead of creating a duplicate.
