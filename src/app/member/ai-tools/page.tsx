...
export default function AIToolsHubPage() {
  ...
  const avatarBadge = avatar?.avatarName ? (
    <span className="inline-flex items-center gap-1.5 text-xs font-medium text-[#3dc3ff] bg-[#3dc3ff]/10 px-2 py-1 rounded-full">
      <span className="w-1.5 h-1.5 rounded-full bg-[#3dc3ff]" />
  ...
  const tools = [
    ...
    {
      href: "/member/ai-tools/title-creator",
      icon: "✍️",
      title: "Title Creator",
