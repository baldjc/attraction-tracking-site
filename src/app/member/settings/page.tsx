  ...
  return (
    <div className="space-y-6">
      <div className="mb-8">
        ...
        <p className="text-[#1e2a38]/60 mt-1">Manage your profile and AI personalisation</p>
      </div>
        ...
        <div className="p-6">
          {loading ? (
            ...
            <div className="space-y-5">
              <div className="bg-[#f1f1ef] rounded-xl p-5">
                <div className="flex items-start justify-between gap-4 mb-4">
                  <div>
                    ...
                    {avatar?.updatedAt && (
                      <p className="text-xs text-[#1e2a38]/40 mt-0.5">Last updated {new Date(avatar.updatedAt).toLocaleDateString()}</p>
                    )}
                  </div>
                  <Link href="/member/ai-tools/avatar-architect" className="text-xs text-[#3dc3ff] border border-[#3dc3ff]/30 px-3 py-1.5 rounded-lg hover:bg-[#3dc3ff]/10 transition-colors">
                    Rebuild Avatar
                  </Link>
                </div>
              ...
              <div>
                <label className="block text-sm font-semibold text-[#1e2a38] mb-2">Edit Avatar Document</label>
                <textarea
                  value={avatarText}
            ...
            <div className="space-y-4">
              ...
              <div>
                <label className="block text-sm font-semibold text-[#1e2a38] mb-2">Paste your existing avatar document</label>
                <textarea
                  value={avatarText}
                  onChange={(e) => setAvatarText(e.target.value)}
                  rows={10}
