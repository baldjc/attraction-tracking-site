    ...
    <div className="max-w-2xl">
      ...
      <div className="bg-white rounded-lg border border-gray-200 p-6 space-y-5">
        ...
        <div className="flex items-center gap-3 pt-2">
          ...
          <Link href="/admin/academy-manager" className="px-5 py-2.5 border border-gray-200 text-[#2f3437] text-sm font-medium rounded-lg hover:bg-gray-50 transition-colors">
            Cancel
          </Link>
