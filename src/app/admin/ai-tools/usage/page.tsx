    ...
    <div className="max-w-5xl mx-auto px-4 py-6 space-y-8">
      ...
      <div className="grid grid-cols-2 sm:grid-cols-4 gap-4">
        <div className="bg-white border border-gray-200 rounded-lg p-4 text-center">
          <div className="text-3xl font-black text-[#6ba3c7]">{totalConversations}</div>
                  ...
                  <tr key={row.id} className="hover:bg-gray-50 transition-colors">
                    <td className="px-4 py-3">
                      <Link
                        ...
                        className="font-medium text-[#2f3437] hover:text-[#6ba3c7] transition-colors"
                      >
                        {row.name}
                      </Link>
                    ...
                    <td className="px-3 py-3 text-center">
                      <span className="inline-flex items-center justify-center w-7 h-7 bg-[#6ba3c7]/10 text-[#6ba3c7] text-xs font-bold rounded-full">
                        {row.total}
                      </span>
                    </td>
                    {Object.keys(TOOL_LABELS).map((t) => (
            ...
            <li key={conv.id} className="flex items-center justify-between px-4 py-3">
                ...
                <div className="min-w-0">
                  ...
                  <p className="text-xs text-[#2f3437]/40">
                    <Link
                      ...
                      className="hover:text-[#6ba3c7] transition-colors"
                    >
              ...
              <div className="text-right shrink-0 ml-4">
                ...
                {conv.downloadCount > 0 && (
                  <p className="text-xs text-[#6ba3c7]">{conv.downloadCount} downloads</p>
                )}
              </div>
            </li>
          ))}
