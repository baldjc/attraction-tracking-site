  ...
  return (
    <div className="max-w-2xl mx-auto">
      <div className="mb-6">
        ...
        <h1 className="text-xl font-bold text-[var(--abv-text)] mt-1">New Intelligence Run</h1>
      ...
      <form onSubmit={handleSubmit} className="bg-white border border-[var(--abv-text)]/10 rounded-xl p-6 space-y-5">
        <div>
          <label className="block text-xs font-semibold text-[var(--abv-text)]/50 uppercase tracking-wider mb-1.5">
          ...
          />
          <p className="text-xs text-[var(--abv-text)]/40 mt-1">Accepts a @handle, channel URL, or channel ID</p>
        </div>
        ...
        <div>
          ...
          {clientsLoading ? (
            <div className="w-full border border-gray-200 rounded-lg px-3 py-2.5 text-sm text-[var(--abv-text)]/40 bg-gray-50">
              Loading clients…
            </div>
          ) : (
            <select
              ...
              className="w-full border border-gray-200 rounded-lg px-3 py-2.5 text-sm text-[var(--abv-text)] focus:outline-none focus:ring-2 focus:ring-[var(--abv-azure)]/40 bg-white"
            >
          ...
          {!clientsLoading && clients.length === 0 && (
            <p className="text-xs text-[var(--abv-text)]/40 mt-1">
              No clients yet.{" "}
              <Link href="/admin/intelligence/clients/new" className="text-[var(--abv-azure)] hover:underline">
                Create a client
              </Link>{" "}
              to link this run.
            </p>
        ...
        <div className="bg-[var(--abv-bg)] rounded-lg px-4 py-3 text-xs text-[var(--abv-text)]/60 space-y-1">
          <p className="font-semibold text-[var(--abv-text)]/70">What this run does:</p>
        ...
        <button
          ...
          className="w-full bg-[var(--abv-dark)] text-white font-semibold py-3 rounded-lg hover:bg-black/85 disabled:opacity-50 disabled:cursor-not-allowed transition-colors text-sm"
        >
