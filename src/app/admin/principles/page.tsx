...
export default function PrinciplesPage() {
  ...
  if (role !== "admin") {
    return <div className="p-8 text-[#2f3437]/50">Access denied.</div>;
  }
  ...
  return (
    <div className="max-w-4xl mx-auto px-4 py-8">
      ...
      <div className="flex items-center justify-between mb-6">
        <div>
          <h1 className="text-2xl font-bold text-[#2f3437]">Principles</h1>
        ...
        <button
          onClick={openAdd}
          className="flex items-center gap-1.5 bg-[#6ba3c7] text-white text-sm font-semibold px-4 py-2 rounded-lg hover:bg-[#5a8fb3] transition-colors"
        >
      ...
      <div className="bg-white rounded-xl border border-gray-200 overflow-hidden">
        {loading ? (
          ...
          <div className="py-16 text-center text-[#2f3437]/40 text-sm">No principles yet. Click "Add Principle" to get started.</div>
        ) : (
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/40 p-4">
          <div className="bg-white rounded-xl shadow-2xl border border-gray-200 w-full max-w-md p-6 space-y-4">
            ...
            <div className="space-y-3">
              <div>
                <label className="block text-xs font-semibold text-[#2f3437]/60 mb-1">Name <span className="text-red-500">*</span></label>
                <input
                  autoFocus
                  type="text"
                  value={form.name}
              ...
              <div>
                <label className="block text-xs font-semibold text-[#2f3437]/60 mb-1">Slug <span className="text-red-500">*</span></label>
                <input
                  type="text"
                  value={form.slug}
                ...
                />
                <p className="text-[10px] text-[#2f3437]/40 mt-0.5">Auto-generated from name. Used for course lesson tagging.</p>
              </div>
              <div>
              ...
              <div className="flex items-center gap-2">
                <input
                  ...
                  className="rounded"
                />
                <label htmlFor="isActive" className="text-sm text-[#2f3437]">Active</label>
              </div>
            </div>
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/40 p-4">
          <div className="bg-white rounded-xl shadow-2xl border border-gray-200 w-full max-w-sm p-6 space-y-4">
            <div className="flex items-center justify-between">
              ...
              <button onClick={() => { setDeleteConfirm(null); setDeleteError(null); }} className="text-[#2f3437]/40 hover:text-[#2f3437] p-1">
                <XMarkIcon className="w-5 h-5" />
              </button>
            </div>
