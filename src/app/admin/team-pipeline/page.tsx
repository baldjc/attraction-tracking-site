  ...
  if (!flags.team_pipeline) {
    return (
      <div className="p-8">
        ...
        <p className="text-sm text-[#2f3437]/60 mt-2">This feature is currently disabled. Enable <code>team_pipeline</code> in Admin Settings → Feature Visibility to use it.</p>
      </div>
    );
  }
