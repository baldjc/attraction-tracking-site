...
export default function StepGoals({ initialIncomeGoal, initialPostingRhythm, initialChallenge, onNext }: Props) {
  ...
  const pillSelected = "bg-[#6ba3c7] text-white border-[#6ba3c7]";
  const pillUnselected = "bg-white dark:bg-[#1a1a1a] text-[#2f3437]/70 dark:text-white/60 border-[#2f3437]/15 dark:border-white/15 hover:border-[#6ba3c7]/50";

  const chipBase = "rounded-full px-2.5 py-1 text-xs border cursor-pointer transition-colors";
  const chipSelected = "bg-[#6ba3c7]/10 text-[#6ba3c7] border-[#6ba3c7]/30";
  const chipUnselected = "text-[#2f3437]/50 dark:text-white/40 border-[#2f3437]/10 dark:border-white/10 hover:border-[#6ba3c7]/30";

  return (
    <div className="space-y-6">
      <div>
        <label className="block text-sm font-medium text-[#2f3437] dark:text-white mb-2">Income goal from YouTube</label>
      ...
      <div>
        <label className="block text-sm font-medium text-[#2f3437] dark:text-white mb-2">Posting rhythm</label>
        <div className="flex flex-wrap gap-2">
      ...
      <div>
        <label className="block text-sm font-medium text-[#2f3437] dark:text-white mb-0.5">Biggest challenge right now</label>
        <p className="text-xs text-[#2f3437]/50 dark:text-white/40 mb-2">Optional — helps your coach understand where you&apos;re at.</p>
