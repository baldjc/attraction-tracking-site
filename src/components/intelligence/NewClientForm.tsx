...
export default function NewClientForm() {
  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-5">
      <div className="bg-white border border-[#2f3437]/10 rounded-xl p-6 space-y-4">
        <h2 className="font-semibold text-[#2f3437] text-sm uppercase tracking-wide">Client Details</h2>
        ...
        <div className="grid grid-cols-2 gap-4">
          <div>
            ...
            <input
              ...
              className="w-full px-3 py-2 border border-[#2f3437]/20 rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-[#6ba3c7]/30"
            />
          </div>
          <div>
        ...
        <div className="grid grid-cols-2 gap-4">
          <div>
            <label className="block text-xs font-medium text-[#2f3437]/60 mb-1">City *</label>
            <input
              required
              value={form.city}
          ...
          <div>
            <label className="block text-xs font-medium text-[#2f3437]/60 mb-1">Province</label>
            <input
              value={form.province}
        ...
        <div>
          <label className="block text-xs font-medium text-[#2f3437]/60 mb-1">Niche *</label>
          <input
            required
            value={form.niche}
      ...
      <div className="bg-white border border-[#2f3437]/10 rounded-xl p-6 space-y-4">
        <h2 className="font-semibold text-[#2f3437] text-sm uppercase tracking-wide">Audience</h2>

        <div>
          <label className="block text-xs font-medium text-[#2f3437]/60 mb-1">Primary Audience *</label>
          <select
            value={form.audiencePrimary}
            onChange={(e) => set("audiencePrimary", e.target.value)}
            className="w-full px-3 py-2 border border-[#2f3437]/20 rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-[#6ba3c7]/30 bg-white"
          >
        ...
        <div>
          <label className="block text-xs font-medium text-[#2f3437]/60 mb-2">Secondary Audiences</label>
              ...
              <button
                ...
                className={`px-3 py-1 rounded-full text-xs border transition-colors ${
                  form.audienceSecondary.includes(o.value)
                    ...
                    : "bg-white text-[#2f3437]/60 border-[#2f3437]/20 hover:border-[#6ba3c7]"
                }`}
              >
                {o.label}
              </button>
      ...
      <div className="bg-white border border-[#2f3437]/10 rounded-xl p-6">
        ...
        <textarea
          ...
          className="w-full px-3 py-2 border border-[#2f3437]/20 rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-[#6ba3c7]/30 resize-none"
        />
      </div>
      ...
      <div className="flex justify-end gap-3">
        <button
          ...
          className="px-4 py-2 text-sm text-[#2f3437]/60 hover:text-[#2f3437] transition-colors"
        >
          Cancel
        </button>
        <button
          type="submit"
          disabled={loading}
          className="px-5 py-2 bg-[#6ba3c7] text-white text-sm font-semibold rounded-lg hover:bg-[#5490b5] transition-colors disabled:opacity-60"
        >
