      ...
      <div className="pt-4 border-t border-[#1e2a38]/10 mt-4">
        <div className="flex gap-2">
          <input
            ...
            disabled={loading}
            className="flex-1 bg-white border border-[#1e2a38]/20 rounded-xl px-4 py-2.5 text-sm text-[#1e2a38] placeholder-[#1e2a38]/30 focus:outline-none focus:ring-2 focus:ring-[#3dc3ff]/40"
          />
          <button
            onClick={handleSend}
