        ...
        <div className="space-y-4">
          <div>
            ...
            <input
              ...
              className="w-full border border-gray-200 rounded-xl px-4 py-3 text-sm text-[#1e2a38] placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-[#3dc3ff]/40"
            />
          </div>
          ...
          <div>
            ...
            <textarea
              ...
              rows={14}
              className="w-full border border-gray-200 rounded-xl px-4 py-3 text-sm text-[#1e2a38] placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-[#3dc3ff]/40 resize-y"
            />
          </div>
        ...
        <div className="flex flex-col h-[70vh]">
          ...
          <div className="flex gap-2 mt-3 border-t border-gray-100 pt-3">
            <textarea
              ...
              rows={2}
              className="flex-1 border border-gray-200 rounded-xl px-3 py-2 text-sm text-[#1e2a38] placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-[#3dc3ff]/40 resize-none"
            />
            <button
              onClick={handleSend}
