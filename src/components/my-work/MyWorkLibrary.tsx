...
/**
 * The member's saved-asset library (scripts, in-progress drafts, ideas,
 * reviews/analyses, repurposed content). Folded into the Content Planner as the
 * "Library" view so the Planner is the single home for every piece of content —
 * the pipeline views show ContentPlan rows, this view aliases the saved assets.
 * Nothing is migrated or deleted; this is a read-only surface over /api/member/my-work.
 */
export default function MyWorkLibrary() {
