...
- Talking points: 3-5 specific points in the avatar's voice, addressing their stresses
  ...
  "ideas": [
    {
      ...
      "talkingPoints": [
        "Capacity panic — life is already full, adding a transaction feels impossible",
        "Disruption fear — life is good, what if chasing better breaks what works",
        "Timing doubt — is now right or are you forcing it",
        "Permission guilt — do you need this or are you being greedy",
        "Partner misalignment — are you both actually on the same page"
      ],
